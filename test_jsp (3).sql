...
insert into loans(CustomerID,TypeID,EmpID,Duration,Principal,Monthly_inst) values (cusid,typeid,empid,duration,principal,mnth_inst);
end$$
...
INSERT INTO `customer` (`CustomerID`, `FirstName`, `LastName`, `Email`, `Address`, `PhoneNum`) VALUES
(22, 'Prathamesh', 'Joshi', 'prathamesh.98223@gmail.com', 'Nilgiri', '8805020280'),
(23, 'Arnab', 'Goswami', 'ag@gmail.com', 'Delhi', '1234567899');
...
(1, 'Prathamesh', 'Joshi', 'prathamesh.98223@gmail.com', 'Nilgiri', '8805020280', 1, 1, 'A great CRM app XD', 'call', '2019-09-20', 1, 1, 1),
...
(27, 'Arnab', 'Goswami', 'ag@gmail.com', 'Delhi', '1234567899', 1, 1, 'i need to know the nation needs to know', 'email', '2019-09-20', 1, 2, 2);
...
INSERT INTO `loans` (`LoaneeID`, `CustomerID`, `TypeID`, `EmpID`, `Duration`, `Principal`, `Monthly_inst`, `Amt_paid`) VALUES
(7, 23, 1, 2, 2, 1200000, 54250, NULL),
(6, 22, 1, 1, 1, 1200000, 108500, NULL);
...
INSERT INTO `tasks` (`TaskID`, `EmpID`, `Task`, `Start_date`, `Status`) VALUES
(1, 1, 'hello world', '2019-10-12', 2),
(2, 1, 'hello', '2019-10-12', 2),
(3, 1, 'hello world', '2019-10-26', 1);
COMMIT;
